        ...
        <div className="min-h-screen flex flex-col bg-gray-50">
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                            ...
                            <span className="text-xl font-bold">Meilleur SUV écolo</span>
                        </div>
                        <nav>
            ...
            <main className="flex-1 container mx-auto px-4 py-8">
                <div className="max-w-4xl mx-auto">
                    <h1 className="text-3xl font-bold text-center mb-8">Trouvez le SUV le plus écologique pour vos
                        besoins</h1>
                    <p className="text-gray-600 text-center mb-8">
                        Comparez les SUVs les plus respectueux de l'environnement et trouvez celui qui correspond à vos
                        critères.
                    </p>
                    ...
                    <div id="results" className="bg-white p-6 rounded-lg shadow-md">
                        ...
                        <div className="bg-red-50 border border-red-200 p-4 rounded-md mb-6 flex items-start">
                            ...
                            <div>
                                ...
                                <p className="text-red-600">Nous n'avons trouvé aucun SUV qui répond à vos critères
                                    écologiques.</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-gray-100 p-6 rounded-lg">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-semibold mb-2">La vérité sur les SUVs et
                                        l'environnement</h3>
                                    <p className="text-gray-700 mb-4">
                                        En réalité, aucun SUV n'est véritablement écologique. Leur poids plus élevé,
                                        leur aérodynamisme
                                        moins efficace et leur consommation supérieure en font des véhicules
                                        intrinsèquement moins
                                        respectueux de l'environnement que des alternatives plus compactes.
                                    </p>
                                    <p className="text-gray-700 mb-4">
                                        Même les SUVs hybrides ou électriques ont un impact environnemental plus
                                        important que leurs
                                        équivalents en berline ou en citadine, notamment en raison de leur production
                                        qui nécessite plus de
                                        matériaux et d'énergie.
                                    </p>
                                    <p className="text-gray-700 font-medium">Pour un véritable choix écologique,
                                        considérez plutôt:</p>
            ...
            <footer className="bg-gray-800 text-white py-8">
                <div className="container mx-auto px-4">
                    <div className="text-center">
                        <p className="mb-2">
                            Meilleur SUV écolo - Un site satirique pour sensibiliser à l'impact environnemental des
                            SUVs
                        </p>
                        <p className="text-gray-400 text-sm">
                            Ce site est une parodie. Aucun SUV n'est réellement écologique, c'est pourquoi notre moteur
                            de recherche
